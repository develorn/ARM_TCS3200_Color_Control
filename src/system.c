	...
	//	RCC_DeInit();
		...
		if (HSEStartUpStatus == SUCCESS)
		{
			...
			RCC_PCLK1Config(RCC_HCLK_Div2);	/* PCLK1 = HCLK/2 */
			 ...
			 RCC_PLLConfig (RCC_PLLSource_HSE_Div1 , RCC_PLLMul_3);		//set PLL source clock and clock multiplier; PLLCLK = 8MHz * 3 = 24 MHz
	#else
			 RCC_PLLConfig (RCC_PLLSource_PREDIV1 , RCC_PLLMul_3);		//set PLL source clock and clock multiplier; PLLCLK = 8MHz * 3 = 24 MHz
	#endif /* STM32F10X_CL */
	...
	//	/* SysTick end of count event each 1ms */
		...
		RCC_APB2PeriphClockCmd(
				RCC_APB2Periph_GPIOA | RCC_APB2Periph_GPIOB | RCC_APB2Periph_GPIOC
						...
						| RCC_APB2Periph_GPIOF | RCC_APB2Periph_GPIOG | RCC_APB2Periph_AFIO | RCC_APB2Periph_TIM1, ENABLE);
...
void GPIOInit()
{
	...
	GPIO_InitStruct.GPIO_Pin = GPIO_Pin_9 | GPIO_Pin_8; //led
